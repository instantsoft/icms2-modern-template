...
<div id="widget_image_<?php echo $dom_id; ?>" class="widget_image_single">
    ...
    <div class="form-row">
        <div class="preview block" <?php if (!$is_image_exists) { ?>style="display:none"<?php } ?>>
            ...
            <a href="javascript:" onclick="icms.images.remove('<?php echo $dom_id; ?>')" class="btn btn-secondary">
    ...
    <div class="d-flex align-items-center">
        <div class="upload pr-2" <?php if ($is_image_exists) { ?>style="display:none"<?php } ?>>
            <div id="file-uploader-<?php echo $dom_id; ?>"></div>
        </div>
        <?php if($allow_import_link){ ?>
            <div class="image_link upload" <?php if ($is_image_exists) { ?>style="display:none"<?php } ?>>
